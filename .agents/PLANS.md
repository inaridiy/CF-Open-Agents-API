...
Small corrections do not need a plan file.

Keep current service contracts in `docs/`. Notes must not contain credentials,
private conversations, machine-specific paths, cache IDs or unrelated history.
